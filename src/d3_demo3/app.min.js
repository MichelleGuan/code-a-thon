...
!function () {
    ...
    function test(e) {   
        console.log(e.objects.countries)
    ...
    var o = 600
        , d = o
        , p = d3.geo.orthographic().translate([o / 2, d / 2]).scale(295).clipAngle(90).precision(.1).rotate([0, -30])
        , i = d3.geo.path().projection(p)
        , c = d3.geo.graticule()()
        , s = d3.select("#map").append("svg").attr("width", o).attr("height", d).call(d3.behavior.drag().origin(function () {
            var t = p.rotate();
            return {
                x: 2 * t[0],
                y: -2 * t[1]
